...
__all__ = [ 'IPictureDisp', 'OLE_CANCELBOOL', 'IFontEventsDisp',
           'Color', 'FONTUNDERSCORE', 'FontEvents',
           'OLE_OPTEXCLUSIVE', 'OLE_XPOS_HIMETRIC', 'Default',
           'VgaColor', 'Picture', 'Font', 'OLE_COLOR', 'Unchecked',
           'Monochrome', 'OLE_YSIZE_CONTAINER', 'OLE_YPOS_PIXELS',
           'FONTSTRIKETHROUGH', 'OLE_ENABLEDEFAULTBOOL', 'FONTBOLD',
           'FONTNAME', 'IFont', 'StdPicture', 'OLE_XPOS_CONTAINER',
           'OLE_XSIZE_CONTAINER', 'OLE_XPOS_PIXELS', 'FONTITALIC',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_CONTAINER', 'IPicture',
           'OLE_YSIZE_HIMETRIC', 'OLE_TRISTATE', 'OLE_YPOS_HIMETRIC',
           'Gray', 'StdFont', 'FONTSIZE', 'OLE_HANDLE', 'Checked',
